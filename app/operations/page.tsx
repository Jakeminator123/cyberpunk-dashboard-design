    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">New Operation</Button>
          <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">Mission Brief</Button>
        </div>
      </div>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-neutral-800 rounded-full h-3">
                        <div
                          className="bg-scout-lime h-3 rounded-full transition-all duration-300"
                    ...
                    <div className="space-y-2">
                      {selectedOperation.objectives.map((objective, index) => (
                        <div key={index} className="flex items-center gap-2 text-sm">
                          <div className="w-2 h-2 bg-scout-lime rounded-full"></div>
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">Update Status</Button>
                <Button
                  variant="outline"
