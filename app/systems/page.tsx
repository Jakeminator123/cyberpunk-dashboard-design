...
export default function SystemsPage() {
  ...
  const getHealthColor = (health) => {
    ...
    if (health >= 70) return "text-scout-lime"
    return "text-red-500"
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">System Scan</Button>
          <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">Maintenance Mode</Button>
        </div>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-scout-lime font-mono">3</p>
              </div>
              <AlertTriangle className="w-8 h-8 text-scout-lime" />
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {systems.map((system) => (
          <Card
            key={system.id}
            className="bg-neutral-900 border-neutral-700 hover:border-scout-lime/50 transition-colors cursor-pointer"
              ...
              <div className="grid grid-cols-3 gap-4 text-xs">
                <div>
                  ...
                  <div className="w-full bg-neutral-800 rounded-full h-1 mt-1">
                    <div
                      className="bg-scout-lime h-1 rounded-full transition-all duration-300"
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="w-full bg-neutral-800 rounded-full h-2">
                          <div
                            className="bg-scout-lime h-2 rounded-full transition-all duration-300"
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-scout-lime hover:bg-scout-lime-deep text-scout-ink">Restart System</Button>
                <Button
                  variant="outline"
